...
def _build_gemini_visual_prompt(article: Article, scenes_json: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        "- Include explicit visual hierarchy and foreground/midground/background elements.\n"
        "- For graphics-heavy scenes, include exact labels, numbers, callouts, and where each element appears.\n"
        ...
        "- Style target: broadcast-news realism, clean typography zones, high contrast, and legible data overlays.\n"
